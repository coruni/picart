...
import { IsNotEmpty, IsString, IsNumber, IsOptional, IsArray, IsString as IsStringArray, MaxLength } from 'class-validator';
...
export class CreateArticleDto {
  ...
  @ApiProperty({ description: '文章图片', example: 'https://example.com/image.jpg', required: false })
  @IsOptional()
  @IsString({ message: '文章图片必须是字符串' })
  images?: string;

  @ApiProperty({ description: '封面图片', example: 'https://example.com/image.jpg', required: false })
  @IsOptional()
