...
export class CollectionController {
  ...
  findAll(
    @Request() req: Request & { user: User },
    @Query() queryDto: QueryCollectionDto,
  ) {
  ...
  @ApiParam({ name: "articleId", description: "文章ID" })
  checkArticleInCollections(
    @Param("articleId", ParseIntPipe) articleId: number,
    @Request() req: Request & { user: User },
  ) {
    return this.collectionService.checkArticleInCollections(
      req.user.id,
      articleId,
    );
  }
  ...
  @ApiParam({ name: "articleId", description: "文章ID" })
  getArticleCollectionInfo(
    @Param("articleId", ParseIntPipe) articleId: number,
    @Request() req: Request & { user: User },
  ) {
    return this.collectionService.getArticleCollectionInfo(
      req.user.id,
      articleId,
    );
  }
