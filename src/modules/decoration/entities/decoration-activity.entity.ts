...
export class DecorationActivity {
  ...
  @Column({
    ...
    comment:
      "活动类型：LIKE-点赞，COMMENT-评论，SHARE-分享，RECHARGE-充值，SIGN_IN-签到，CUSTOM-自定义",
  })
  ...
  @ApiProperty({ description: "关联文章ID（活动说明）", required: false })
  @Column({ nullable: true, comment: "关联文章ID（活动说明）" })
  articleId: number | null;

  @ApiProperty({ description: "关联文章（活动说明）", required: false })
