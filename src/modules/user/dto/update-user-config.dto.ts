...
export class UpdateUserConfigDto {
  ...
  @ApiProperty({ description: "会员抽成比例，0-1 之间", required: false })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(1)
  ...
  @ApiProperty({ description: "商品抽成比例，0-1 之间", required: false })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(1)
  ...
  @ApiProperty({ description: "服务抽成比例，0-1 之间", required: false })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(1)
  ...
  @ApiProperty({ description: "是否隐藏收藏夹列表", required: false })
  @IsOptional()
  @IsBoolean()
  hideCollections?: boolean;

  @ApiProperty({ description: "是否隐藏粉丝列表", required: false })
  @IsOptional()
  @IsBoolean()
  hideFollowers?: boolean;

  @ApiProperty({ description: "是否隐藏关注列表", required: false })
  @IsOptional()
  @IsBoolean()
  hideFollowings?: boolean;

  @ApiProperty({ description: "是否隐藏标签列表", required: false })
  @IsOptional()
  @IsBoolean()
  hideTags?: boolean;
