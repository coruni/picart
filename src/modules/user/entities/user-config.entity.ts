...
export class UserConfig {
  ...
  @Column({
    comment: "文章抽成比例，0-1 之间，如 0.1 表示 10%",
    type: "decimal",
    precision: 3,
    scale: 2,
    default: 0.1,
  ...
  @Column({
    comment: "会员抽成比例，0-1 之间，如 0.1 表示 10%",
    type: "decimal",
    precision: 3,
    scale: 2,
    default: 0.1,
  ...
  @Column({
    comment: "商品抽成比例，0-1 之间，如 0.1 表示 10%",
    type: "decimal",
    precision: 3,
    scale: 2,
    default: 0.1,
  ...
  @Column({
    comment: "服务抽成比例，0-1 之间，如 0.1 表示 10%",
    type: "decimal",
    precision: 3,
    scale: 2,
    default: 0.1,
  ...
  @ApiProperty({ description: "是否隐藏评论列表" })
  @Column({
    comment: "是否隐藏评论列表",
    default: false,
  })
  ...
  @ApiProperty({ description: "是否隐藏收藏夹列表" })
  @Column({
    comment: "是否隐藏收藏夹列表",
    default: false,
  })
  ...
  @ApiProperty({ description: "是否隐藏粉丝列表" })
  @Column({
    comment: "是否隐藏粉丝列表",
    default: false,
  })
  ...
  @ApiProperty({ description: "是否隐藏关注列表" })
  @Column({
    comment: "是否隐藏关注列表",
    default: false,
  })
  ...
  @ApiProperty({ description: "是否隐藏标签列表" })
  @Column({
    comment: "是否隐藏标签列表",
    default: false,
  })
